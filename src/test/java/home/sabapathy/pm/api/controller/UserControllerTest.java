...
public class UserControllerTest {
    ...
    public void beforeAnyTest() {
        ...
        userResponse = new UserResponse(1, 1, "Selva", "Sabapathy");
    ...
    public void testGet() throws Exception {
        ...
        log.debug("UserResponse: {}", mvcResult.getResponse().getContentAsString());

        assertThat("Should be a OK", mvcResult.getResponse().getStatus(), is(200));
        assertThat("Incorrect UserResponse", mvcResult.getResponse().getContentAsString(), is("{\"userId\":1,\"employeeId\":1,\"firstName\":\"Selva\",\"lastName\":\"Sabapathy\"}"));
    }
    ...
    public void testGetAll() throws Exception {
        ...
        log.debug("Status: {}", mvcResult.getResponse().getStatus());
        log.debug("UserResponses: {}", mvcResult.getResponse().getContentAsString());

        assertThat("Should be a OK", mvcResult.getResponse().getStatus(), is(200));
        assertThat("Incorrect List<UserResponse>", mvcResult.getResponse().getContentAsString(), is("[{\"userId\":1,\"employeeId\":1,\"firstName\":\"Selva\",\"lastName\":\"Sabapathy\"}]"));
    }
